...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (heading) typeEffect(heading, window.innerWidth < 768 ? 50 : 80);
});
...
function createParticles() {
    ...
    const totalParticles = window.innerWidth < 768 ? 8 : 15;
...
document.querySelector(".hero-img img").addEventListener("click", () => {
    ...
    const totalExplosions = window.innerWidth < 768 ? 20 : 40;
    for (let i = 0; i < totalExplosions; i++) {
        ...
        let x = (Math.random() - 0.5) * (window.innerWidth < 768 ? 300 : 400);
        let y = (Math.random() - 0.5) * (window.innerWidth < 768 ? 300 : 400);
...
>>>>>>> 1211c4f5105115fa79113cc15c8bf26e33dc2ee9
